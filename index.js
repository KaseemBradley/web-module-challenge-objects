...
console.log(createMenuItem("hot dog", 4, "dinner"));
console.log(createMenuItem("hot dog", 5, "dinner"));
console.log(createMenuItem("hot dog", 6, "dinner"));
...
function getReviewByIndex(array, num) {
  let indexReviews = `${array[num].name} gave the restaurant a ${array[num].rating} star review, and their feedback was: ${array[num].feedback}`;
  return indexReviews
}
